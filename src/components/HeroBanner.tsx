    ...
    <div className="mx-1 my-1">
      <div className="relative w-full h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden border border-border bg-gradient-to-br from-primary/5 to-primary/10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="bg-background/95 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-border">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-4 left-4 w-16 h-16 bg-primary/10 rounded-xl"></div>
        <div className="absolute bottom-4 right-4 w-20 h-20 bg-primary/10 rounded-xl"></div>
        <div className="absolute top-1/2 left-8 w-12 h-12 bg-primary/5 rounded-lg transform -translate-y-1/2"></div>
        <div className="absolute top-1/2 right-8 w-12 h-12 bg-primary/5 rounded-lg transform -translate-y-1/2"></div>
      </div>
    </div>
  );
};
